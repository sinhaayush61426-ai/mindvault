...
Before working on MindVault, review the **[Workspace Instructions](.github/copilot-instructions.md)** for comprehensive development guidelines covering:
...
1. **Clone and install** (see [Getting Started](#getting-started))
...
| Resource | Purpose |
|----------|---------|
| [Workspace Instructions](.github/copilot-instructions.md) | AI-friendly development guide with architecture, patterns, and checklists |
| [EXPANSION.md](EXPANSION.md) | Detailed v2.0 feature documentation (500+ lines) |
| [MIGRATION.md](MIGRATION.md) | Upgrade guide for v1 → v2 (backward compatible) |
| [requirements.txt](requirements.txt) | Python dependencies and versions |
| [manifest.json](manifest.json) | PWA configuration and metadata |
